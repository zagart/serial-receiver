...
public class SerialReceiverMain {
     ...
     * Пример входных параметров: COM1 windows-1251 ru.
     * Первый параметр - имя последовательного порта для подключения. Второй
     * параметр - кодировка для вывода сообщений (системная кодировка Windows:
     * windows-1251, но ее перекрывает кодировка консоли: cp866). Третий
     * параметр - локаль. Доступны русская и английская (ru/en).
     *
